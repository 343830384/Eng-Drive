...
### 声明
   ...
   * Eng 致力于精简所有同类工具中的技术玄学 , 用最 简明、简易和最少的API实现同类工具的核心部分 ,摒除一切冗余的学习内容达成同样的目的. 
   * 此外作者建议学好javascript基础和jquery , "乱花渐欲迷人眼 浅草才能没马蹄" ; 单纯服务器到页面可见部分的内容的逻辑规则事实上是有固化有规律可循的, 未来必将出现出现整站式万能的 傻瓜配置一条龙服务,并有着优异的性能 . 或者AI来替代. 任何有规律,有迹可循,可以固化的工作内容 都是值得被担心,被警惕的. 相反个性页面的审美,交互操作是无法固化,无法用规律准确描述的存在,这正是建议所在,
